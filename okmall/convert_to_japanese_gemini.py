...
KOREAN_TO_JAPANESE = {
    ...
    # 무신사 필수 안내사항 (colorsize_comments 에 저장 → 여기서 정확한 고정 일본어로 치환. Gemini 변질 방지)
    "【상품 상세 안내】": "【商品ディテールに関するご注意】",
    "자수 및 패치, 각종 라벨, 가죽 제품 로고 양각 및 음각 방식, 개체별 제조국 등의 상품 디테일 및 브랜드 택, 브랜드 포장 봉투, 브랜드 더스트 백, 하드케이스, 보증서 등 브랜드 구성품의 경우 생산 시기 및 입출고 시점에 따라 촬영된 상품 사진 및 상세페이지상의 정보와 고객님께서 받아보는 실제 상품의 디테일이 상이할 수 있습니다.": "刺繍やパッチ、各種ラベル、革製品のロゴの型押し（凹凸加工）、個体ごとの原産国などの商品の詳細、ならびにブランドタグ、ブランド包装袋、ブランドダストバッグ（保存袋）、ハードケース、保証書などの付属品につきましては、生産時期や入荷・出荷のタイミングにより、撮影された商品写真や詳細ページ上の情報と、お客様が実際にお受け取りになる商品の仕様が異なる場合がございます。",
