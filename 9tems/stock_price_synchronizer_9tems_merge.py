...
사용법:
    python stock_price_synchronizer_9tems.py                    # 전체 실행
    python stock_price_synchronizer_9tems.py --brand BURBERRY   # 특정 브랜드만
    python stock_price_synchronizer_9tems.py --limit 100        # 최대 100개만
    python stock_price_synchronizer_9tems.py --dry-run          # 테스트 (API 호출 안함)
    python stock_price_synchronizer_9tems.py --force            # 변경 없어도 강제 API 호출
